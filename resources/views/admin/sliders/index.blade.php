    ...
    >
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <div class="">
                    <x-breadcrumbs />
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Sliders</h1>
                </div>
                {{-- <div class="sm:flex">
                    <div
                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button x-on:click="showAddSliderModal = true" type="button" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div class="overflow-x-auto">
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                        {{-- <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <img class="w-10 h-10 rounded-full"
                                            src="http://localhost:1313/images/users/lana-byrd.png" alt="Lana Byrd avatar">
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        ...
                        <livewire:sliders.sliders-table />
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Add Slider Modal -->
        {{-- <livewire:sliders.add-slider-form /> --}}
