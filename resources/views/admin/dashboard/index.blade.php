            ...
            <div
                ...
                <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                    ...
                    <article class="mb-5">
                        ...
                        <p class="mb-2 text-gray-900 dark:text-white">
                            Ok <a href="#"
                                class="font-medium hover:underline text-blue-600 dark:text-blue-500">@team</a> I'am
                            attaching our offer and pitch deck. Take your time to review everything. I'am looking
                            forward to
                    ...
                    <article class="pl-12 mb-5">
                        ...
                        <p class="mb-2 text-gray-900 dark:text-white">
                            Hello <a href="#"
                                class="font-medium hover:underline text-blue-600 dark:text-blue-500">@jeseleos</a> I
