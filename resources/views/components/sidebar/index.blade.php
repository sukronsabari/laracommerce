@php
    $sideLinks = [
        ...
        [
            ...
            'text' => 'Web Management',
            'href' => '#',
            'buttonTriggerIdentifier' => 'web-management-collapse-trigger',
            'collapseIdentifier' => 'web-management-collapse',
            'collapseItems' => [
                [
                    'text' => 'Sliders',
                    'href' => '/admin/sliders',
...
<aside id="sidebar"
    class="hide-scrollbar fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar">
    <div
